...
public class CalScrollView extends ScrollView {
    ...
    public CalScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }

    public CalScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            int scrollY = CalScrollView.this.getScrollY();
