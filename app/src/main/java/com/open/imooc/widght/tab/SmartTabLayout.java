 ...
 */
package com.open.imooc.widght.tab;
    ...
    private void scrollToTab(int tabIndex, int positionOffset) {
        ...
        if (tabStrip.isIndicatorAlwaysInCenter()) {
            ...
            if (isLayoutRtl) {
                ...
                x = SmartTabUtils.getEnd(selectedTab) - SmartTabUtils.getMarginEnd(selectedTab) - positionOffset;
                x -= (first - selected) / 2;
            } else {
                ...
                x = SmartTabUtils.getStart(selectedTab) - SmartTabUtils.getMarginStart(selectedTab) + positionOffset;
                x -= (first - selected) / 2;
            }
        ...
        int x = isLayoutRtl
                ? start + startMargin - positionOffset - getWidth() + SmartTabUtils.getPaddingHorizontally(this)
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (0f < positionOffset && positionOffset < 1f && tabStrip.isIndicatorAlwaysInCenter()) {
                ...
                int current = SmartTabUtils.getWidth(currentTab) / 2 + SmartTabUtils.getMarginEnd(currentTab);
                int next = SmartTabUtils.getWidth(nextTab) / 2 + SmartTabUtils.getMarginStart(nextTab);
